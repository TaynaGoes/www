...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Out-2022 às 22:47
...
INSERT INTO `clientes` (`id`, `cpf`, `nome`, `sobrenome`, `email`, `ddd_celular`, `numero_celular`, `senha`, `status_cliente`, `foto`) VALUES
(25, '41679648802', 'tayna', 'goes', 'taynagoes02@gmail.com', '18', '988071968', '12345', 1, NULL),
(26, '41679648802', 'tayna', 'goes', 'taynagoes02@gmail.com', '18', '988071968', '12345', 1, NULL),
(27, '41679648802', 'Tayna', 'teste', 'tayna@teste.com.br', '00', '36363636', '123', 1, NULL);
...
(10, 'O Rei Leão', 'Clássico da Disney, a animação acompanha Mufasa (voz de James Earl Jones), o Rei Leão, e a rainha Sarabi (voz de Madge Sinclair), apresentando ao reino o herdeiro do trono, Simba (voz de Matthew Broderick). O recém-nascido recebe a bênção do sábio babuíno Rafiki (voz de Robert Guillaume), mas ao crescer é envolvido nas artimanhas de seu tio Scar (voz de Jeremy Irons), o invejoso e maquiavélico irmão de Mufasa, que planeja livrar-se do sobrinho e herdar o trono.', 27, '10', 89, 'livre', 'dublado', '20', '40', 1994, 'Roger Allers', 'Garcia Júnior', 'Matthew Broderick', 'James Earl Jones');
